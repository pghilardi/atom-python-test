...
export default class AtomPythonTestViewDock {
  ...
  printOutput(junitOutput){
    ...
    numberOfTests = junitOutput.junit_info.tests.count
    passedTests = junitOutput.junit_info.tests.passed
    failedTests = junitOutput.junit_info.tests.failure
    this.message.innerHTML = "Summary: " + numberOfTests + " tests were executed: passed (" + passedTests + ") failed (" + failedTests + ")";
